                        ...
                        @endif
                            ...
                            <div class="form-group">
                                <label for="" class="col-md-4 control-label"> Product Name</label>
                                    <div class="col-md-4">
                                    <input type="text" id="name" placeholder="Product Name" class="form-control input-md" wire:model="name"  wire:keyup="generateSlug"/>
                            ...
                            <div class="form-group">
                                <label for="" class="col-md-4 control-label"> Product Slug</label>
                                    <div class="col-md-4">
                                    <input type="text" placeholder="Product Slug" id="slug" class="form-control input-md" wire:model="slug"  />
                                ...
                                <label for="" class="col-md-4 control-label">Stock</label>
                                    <div class="col-md-4">
                                        <select  class="form-control" wire:model="stock_status">
                                            ...
                                            <option value="outfstock">Out of Stock</option>
                                        </select>
