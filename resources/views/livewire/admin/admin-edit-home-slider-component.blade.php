                        ...
                        @endif
                            ...
                            <div class="form-group">
                                <label for="" class="col-md-4 control-label"> Title</label>
                                    <div class="col-md-4">
                                    <input type="text" placeholder="Title Slider" class="form-control input-md" wire:model="title" />
                                    </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="" class="col-md-4 control-label">Subtitle</label>
                                    <div class="col-md-4">
                                    <input type="text" placeholder="Subtitle Slider" class="form-control input-md" wire:model="subtitle"  />
                                    </div>
                            </div>
