                        ...
                        <tbody>
                            @foreach($sliders as $slider)
                                <tr>
                                 ...
                                 <a href="#"  onclick="confirm('Are you sure, you want to delete this product : {{$slider->title}}?') || event.stopImmediatePropagation()"  wire:click.prevent="deleteSlide({{$slider->id}})"><i class="fa fa-times fa-2x text-danger"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
